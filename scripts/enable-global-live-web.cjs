...
const newMethod = `  // MKUU_GLOBAL_LIVE_WEB_V3
...
if (oldMethod.test(geminiSource)) {
  ...
  console.log('MKUU: Global live factual-question routing V3 applied.');
} else if (geminiSource.includes('MKUU_GLOBAL_LIVE_WEB_V3')) {
  console.log('MKUU: Global live factual-question routing V3 already applied.');
} else {
