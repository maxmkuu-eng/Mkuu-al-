...
patch(chat, [
  ...
  ['<div className="flex items-center text-xs uppercase tracking-widest text-[#888888] flex-shrink-0"><span className={`status-dot', '<img src={mkuuLogo} alt="MKUU AI" className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl object-cover border border-[#D4AF37]/40 shadow-lg mr-2 flex-shrink-0" /><div className="flex items-center text-xs uppercase tracking-widest text-[#888888] flex-shrink-0"><span className={`status-dot'],
  ['<div className="w-14 sm:w-16 h-14 sm:h-16 rounded-2xl glass border border-[#222222] flex items-center justify-center text-[#D4AF37] mb-4 shadow-2xl"><Crown className="w-7 sm:w-8 h-7 sm:h-8 stroke-[1.5]" /></div>', '<img src={mkuuLogo} alt="MKUU AI" className="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl object-cover border border-[#D4AF37]/40 mb-4 shadow-2xl" />']
]);
...
patch(nav, [
  ...
  ['<div className="w-8 h-8 rounded-lg bg-[#D4AF37] flex items-center justify-center text-black font-bold"><Crown className="w-4 h-4"/></div>', '<img src={mkuuLogo} alt="MKUU AI" className="w-9 h-9 rounded-xl object-cover border border-[#D4AF37]/40 shadow-lg" />'],
  ['<div><h1 className="serif text-2xl font-bold tracking-widest text-[#D4AF37]">MKUU AI</h1><p className="text-[10px] uppercase tracking-[0.2em] text-[#888888] mt-0.5">Premium Assistant</p></div>', '<div className="flex items-center gap-3"><img src={mkuuLogo} alt="MKUU AI" className="w-12 h-12 rounded-2xl object-cover border border-[#D4AF37]/40 shadow-lg" /><div><h1 className="serif text-2xl font-bold tracking-widest text-[#D4AF37]">MKUU AI</h1><p className="text-[10px] uppercase tracking-[0.2em] text-[#888888] mt-0.5">Premium Assistant</p></div></div>'],
  ['<span className="font-mono text-[#888888]">v2.5</span></div></div></nav></>};', '<span className="font-mono text-[#888888]">v2.5</span></div><div className="mt-2.5 rounded-xl border border-[#222222] bg-white/[0.02] p-2.5 flex items-center gap-2.5"><img src={mkuuLogo} alt="MKUU AI" className="w-9 h-9 rounded-lg object-cover border border-[#D4AF37]/30" /><div><div className="text-[10px] font-bold uppercase tracking-wider text-[#D4AF37]">Kuhusu MKUU AI</div><div className="text-[9px] text-[#888888]">Think • Search • Create • Solve</div></div></div></div></nav></>};']
]);
